...
execute_with_prompt "cd ~/allora-chain/basic-coin-prediction-node && rm -rf config.json"
...
execute_with_prompt "cd ~/allora-chain/basic-coin-prediction-node && rm -rf model.py"
